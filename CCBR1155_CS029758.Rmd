...
output_car_dir = "~/../../Volumes/CUTRUN/analysis/CS029758/r_analysis_230129/"
...
# package list
list.of.packages=c("DESeq2","edgeR", "tidyverse","dplyr", "DT","reshape2","pander","plotly", "ggplot2", "ggfortify", "ggrepel", "yaml", "EnhancedVolcano", "RUVSeq", "ChIPseeker", "stringr","RColorBrewer","HTSFilter","pheatmap",txdb_pkg, "UpSetR","ggupset","ggimage","grid","ggpubr")
...
## **Heatmap**
```{r, h1, echo=FALSE, warning=FALSE,message=FALSE,fig.height=7}
contrast_id="53_H3K27me3_IFNb_vs_HN6_H3K27me3_IFNb"
gene_list=subset(gene_df,Set %in%c("APM","IFNalpha"))$Human
main_differential_genes(contrast_id,contrast_list)
generate_heat_map_differential(contrast_id=contrast_id,
                               n_up=5,
                               n_down=5,
                               fshort="test",
                               gene_list_flag="ON")
...
```{r, h2, echo=FALSE, warning=FALSE,message=FALSE,fig.height=7}
contrast_id="53_H4K20me3_IFNb_vs_HN6_H4K20me3_IFNb"
gene_list=subset(gene_df,Set %in%c("APM","IFNalpha"))$Human
main_differential_genes(contrast_id,contrast_list)
generate_heat_map_differential(contrast_id=contrast_id,
...
# ALL GENES
generate_replicate_heatmaps(contrast_id=contrast_id,
                            peak_type="broadGo",
                            scale="ON",
...
generate_replicate_heatmaps(contrast_id=contrast_id,
                            ...
                            sample_subset=sample_sub_list)
gene_list_name="INFA"
gene_list=subset(gene_df,Set %in% c("IFNalpha"))$Human
generate_replicate_heatmaps(contrast_id=contrast_id,
                            peak_type="broadGo",
                            scale="ON",
                            gene_list_subset=gene_list,
                            sample_subset=sample_sub_list)
gene_list_name="APM"
gene_list=subset(gene_df,Set %in% c("APM"))$Human
generate_replicate_heatmaps(contrast_id=contrast_id,
                            peak_type="broadGo",
                            scale="ON",
                            gene_list_subset=gene_list,
...
contrast_id="53_H4K20me3_IFNb_vs_HN6_H4K20me3_IFNb"
sample_sub_list=c("HN6_H4K20me3_IFNb_1","HN6_H4K20me3_IFNb_2","HN6_H4K20me3_IFNb_3",
                  "53_H4K20me3_IFNb_1","53_H4K20me3_IFNb_2","53_H4K20me3_IFNb_3")
sample_sub_list=c("HN6_H4K20me3_IFNb_2","HN6_H4K20me3_IFNb_3",
                  "53_H4K20me3_IFNb_1","53_H4K20me3_IFNb_2")
# ALL GENES
generate_replicate_heatmaps(contrast_id=contrast_id,
                            peak_type="broadGo",
                            scale="ON",
...
## *Single sample pie charts*
```{r, pie1, echo=FALSE, warning=FALSE,message=FALSE,fig.height=7}
# run function
contrast_id=c("53_H3K27me3_IFNb_vs_HN6_H3K27me3_IFNb")
peak_type="broadGo"
...
# run function
contrast_id=c("53_H4K20me3_IFNb_vs_HN6_H4K20me3_IFNb")
peak_type="broadGo"
single_sample_picharts(contrast_id,peak_type,neg_control)
main_piecharts_from_collapsed_nonsig(contrast_id)
main_piecharts_from_collapsed_secondary(contrast_id)
...
```{r}
contrast_id="53_H4K20me3_IFNb_vs_HN6_H4K20me3_IFNb"
sample_list=c("HN6_H4K20me3_IFNb_2",
              "53_H4K20me3_IFNb_2")
color_pal=c("black","blue")
generate_intensity_boxplot(contrast_id,sample_list,color_pal=color_pal)
```
